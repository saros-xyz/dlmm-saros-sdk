...
var LiquidityBookAbstract = function LiquidityBookAbstract(config) {
  ...
  this.connection = new web3_js.Connection(((_config$options = config.options) == null ? void 0 : _config$options.rpcUrl) || CONFIG[config.mode].rpc, {
    commitment: "confirmed",
    httpHeaders: {
      development: "coin98"
    }
  });
  var provider = new anchor.AnchorProvider(this.connection, window.solana, anchor.AnchorProvider.defaultOptions());
              ...
              var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(mint) {
                ...
                return _regenerator().w(function (_context13) {
                  while (1) switch (_context13.n) {
                    case 0:
                      _context13.n = 1;
                      return web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("position")), mint.toBuffer()], _this2.lbProgram.programId);
                    case 1:
