...
describe("getPoolMetadata", () => {
  ...
  it("should fetch and validate metadata for SOL/USDC Pool", async () => {
    ...
    expect(metadata.baseToken.mintAddress.toString()).toBe("So11111111111111111111111111111111111111112"); // SOL mint
    expect(metadata.quoteToken.mintAddress.toString()).toBe("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"); // USDC mint
  });
});
